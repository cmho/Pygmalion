...
init -1 python hide:
    ...
    config.window_title = u"Pygmalion"
    ...
    theme.diamond(
        # Color scheme: Colorblind (Mou ikkai mod) 
    ...
    #style.window.background = Frame("images/frame.png", 0, 0)
    ...
    style.window.yminimum = 570
    
    style.default.color = "#FFFFFF"
    
    style.input_text.color = "#15eae3"
    style.label_text.bold = False
    style.label_text.color = "#15eae3"
    
    style.say_dialogue.color = "#FFFFFF"
    style.say_dialogue.drop_shadow = [ (-1, -1), (1, -1), (-1, 1), (1, 1) ]
    ...
    style.default.font = "fonts/primer print.otf"
...
python early:
    config.save_directory = "Pygmalion-1291839699"
